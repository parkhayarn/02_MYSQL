...
-- WHERE 에서의 AND 조건은 두 조건을 모두 충족시키는 것을 조회한다.
select menu_name,
       menu_price,
       category_code,
       orderable_status
...
where
    ...
    menu_price <= 25000;    -- 메뉴가격이 25000원 이하
...
from
    tbl_menu
where
    menu_price between 10000 and 25000; -- 메뉴 가격이 10000원 이상 25000원 이하
...
-- 메뉴 가격이 10000원 이상 25000원 이하가 아닌 데이터만 조회
